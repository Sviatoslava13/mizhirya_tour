document.addEventListener('DOMContentLoaded', () => {
    ...
    const routeDetails = {
      ...
      bendzhola: {
        ...
        text: 'Дорогою на Гору Бенджола ви відвідаєте ще одну цікаву локацію — Гуцульські Гиндри. Там є розваги для дітей, а також колиба, де можна відпочити, поїсти й провести час у затишній атмосфері Карпат.'
      },
      'bila-kobyla': {
